...
/**
 * This is the item provider adapter for a {@link apimodeler.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApimodelerPackage.Literals.ACTION__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApimodelerPackage.Literals.ACTION__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addResponsesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_responses_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_responses_feature", "_UI_Action_type"),
				 ApimodelerPackage.Literals.ACTION__RESPONSES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApimodelerPackage.Literals.ACTION__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApimodelerPackage.Literals.ACTION__RESPONSE);
			childrenFeatures.add(ApimodelerPackage.Literals.ACTION__PARAMETER);
		}
	...
	public String getText(Object object) {
		String label = ((Action)object).getType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ApimodelerPackage.Literals.ACTION__RESPONSE,
				 ApimodelerFactory.eINSTANCE.createResponse()));

		newChildDescriptors.add
			(createChildParameter
				(ApimodelerPackage.Literals.ACTION__PARAMETER,
