...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>In</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see apimodeler.ApimodelerPackage#getIn()
 * @model
 * @generated
 */
public enum In implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>In</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final In[] VALUES_ARRAY =
		new In[] {
			QUERY,
			HEADER,
			PATH,
	...
	/**
	 * A public read-only list of all the '<em><b>In</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<In> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>In</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static In get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			In result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>In</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static In getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			In result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>In</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static In get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private In(int value, String name, String literal) {
		this.value = value;
		this.name = name;
