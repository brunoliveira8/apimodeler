 ...
 * @generated
 */
public class ApimodelerSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ApimodelerPackage.API: {
				API api = (API)theEObject;
				T result = caseAPI(api);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.INFORMATION: {
				Information information = (Information)theEObject;
				T result = caseInformation(information);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.RESOURCE: {
				Resource resource = (Resource)theEObject;
				T result = caseResource(resource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.RESPONSE: {
				Response response = (Response)theEObject;
				T result = caseResponse(response);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.DOCUMENT: {
				Document document = (Document)theEObject;
				T result = caseDocument(document);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.FIELD: {
				Field field = (Field)theEObject;
				T result = caseField(field);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.GET: {
			...
			case ApimodelerPackage.POST: {
				Post post = (Post)theEObject;
				T result = casePost(post);
				if (result == null) result = caseAction(post);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.PUT: {
				Put put = (Put)theEObject;
				T result = casePut(put);
				if (result == null) result = caseAction(put);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApimodelerPackage.DELETE: {
			...
			case ApimodelerPackage.PATCH: {
				Patch patch = (Patch)theEObject;
				T result = casePatch(patch);
				if (result == null) result = caseAction(patch);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
