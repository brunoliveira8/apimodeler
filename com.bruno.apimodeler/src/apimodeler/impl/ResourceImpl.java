 ...
 * </p>
 * <ul>
 *   <li>{@link apimodeler.impl.ResourceImpl#getAction <em>Action</em>}</li>
...
public class ResourceImpl extends MinimalEObjectImpl.Container implements Resource {
	...
	public EList<Action> getAction() {
		if (action == null) {
			action = new EObjectContainmentEList<Action>(Action.class, this, ApimodelerPackage.RESOURCE__ACTION);
		}
		return action;
	}
