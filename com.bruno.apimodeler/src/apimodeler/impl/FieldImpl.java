 ...
 * </p>
 * <ul>
 *   <li>{@link apimodeler.impl.FieldImpl#getName <em>Name</em>}</li>
 *   <li>{@link apimodeler.impl.FieldImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldImpl extends MinimalEObjectImpl.Container implements Field {
	...
	protected EClass eStaticClass() {
		return ApimodelerPackage.Literals.FIELD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApimodelerPackage.FIELD__NAME, oldName, name));
	}
