...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generateSwagger" };
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(apimodeler.ApimodelerPackage.class)) {
            resourceSet.getPackageRegistry().put(apimodeler.ApimodelerPackage.eINSTANCE.getNsURI(), apimodeler.ApimodelerPackage.eINSTANCE);
        }
